...
'		   		 var1= JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").JavaStaticText("<html><br>Para Paquete").GetROProperty("label")
'
'			    'var1 = JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").JavaStaticText("<html><br>Para Technical").GetROProperty("label")
''				var1 = Replace(var1,"<html>","")S
''				var1 = Replace(var1,"</html>","")
'				DataTable("s_Resultado", dtLocalSheet) = "Fallido"
'				DataTable("s_Detalle", dtLocalSheet) = var1
'				Reporter.ReportEvent micFail, "Error de financiamiento", "No se ha financiado correctamente"
'		     	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "Financiamiento18cuotasError.png", True
'	         	imagenToWord "Financiamiento Error",RutaEvidencias() & "Financiamiento18cuotasError.png"
'	         		wait 1
...
'				wait 10
'				
'				While JavaWindow("Ejecutivo de interacción").JavaDialog("Mensajes de validación").Exist=False
'					wait 1
'				Wend
'				
'				If 	JavaWindow("Ejecutivo de interacción").JavaDialog("Mensajes de validación").Exist= True Then
...
'					
'					While JavaWindow("Ejecutivo de interacción").JavaDialog("Orden 1070501A > Confirmar").JavaTable("Acciones de orden que").Exist = False
'								wait 1
'					Wend
'							wait 5
'					JavaWindow("Ejecutivo de interacción").JavaDialog("Orden 1070501A > Confirmar").JavaButton("Aceptar").Click
'					
'					
'				End If
'				wait 5
...
Sub EnviarPago()
	...
	t=0
		...
		wait 2
		Dim tarea
		tarea = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Buscar: Grupo de órdenes").JavaTable("Equipo usuario:").GetCellData("#0", "#5")
		If tarea = "Solicitar logística" Then
			JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Buscar: Grupo de órdenes").Close
			Exit Sub
		End If
		wait 1
